<template>
    <div class="social-networks">
        ...
        <a href="https://www.linkedin.com/company/commuz/" target="_blank" class="social-link">LinkedIn</a>
        </div>
        <div class="legal-info">
        <h3>Mentions légales</h3>
        <p>
            La Commuz' est un projet artistique commun à l'École centrale de Lyon et à emlyon business school.
            <br/>
            Elle constitue également un club artistique de l'Association des Élèves de l'École Centrale de Lyon.
        </p>
        <h3>Contacts</h3>
        <p>
            Pour toute question, contactez Agustín, Inès, Antoine et Oscar par mail ou sur notre page Facebook.
            <br/>
            Pour toute demande relative aux partenariats, contactez notre responsable partenariats Vincent.
        </p>
        </div>
    </div>
</template>
